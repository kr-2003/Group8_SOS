...
class Application:
    ...
    def process_image(self, image):
        try:
                ...
                if hands[0]:
                    ...
                    if image.all:
                        ...
                        if handz[0]:
                            ...
                            res=white
                            print("going to predicted", self.str)
            ...
            return "Error in processing image", self.current_image

        return (self.str, self.prev_char)
...
def predict_image(image: UploadFile = File(...)):
    ...
    res_str, curr_letter = hgr.process_image(filename)
    # delete the image file
    os.remove(filename)
    # hgr.speak_fun()f

    print( {"message": "Prediction completed.", "result": res_str, "current_letter": curr_letter})

    return {"message": "Prediction completed.", "result": res_str, "current_letter": curr_letter}
