...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', type=str, default='tiny.en', #no default='large-v2',
    ...
    parser.add_argument('-r', '--rt-model', '--realtime_model_type', type=str, default='tiny.en', # no default='tiny',
    ...
    parser.add_argument('-l', '--lang', '--language', type=str, default='en', # no default='en',
